...
})({"5Sk58":[function(require,module,exports) {
...
var _product1 = require("./controllers/product");
var _productDefault1 = parcelHelpers.interopDefault(_product1);
var _product2 = require("./models/product");
var _productDefault2 = parcelHelpers.interopDefault(_product2);
var _httpService = require("./services/httpService");
var _httpServiceDefault = parcelHelpers.interopDefault(_httpService);
document.addEventListener("DOMContentLoaded", ()=>{
    const productModel = new (0, _productDefault2.default)(new (0, _httpServiceDefault.default)());
    const productView = new (0, _productDefault.default)(".main-content");
    const productController = new (0, _productDefault1.default)(productView, productModel);
    productController.initialize();
});

},{"./views/product":"jVkgG","./controllers/product":"8PaIS","./models/product":"bb6qN","./services/httpService":"35WX5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jVkgG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _selectOption = require("../constants/selectOption");
var _labels = require("@/constants/labels");
var _iconSvg = require("../../asset/images/icon.svg");
var _iconSvgDefault = parcelHelpers.interopDefault(_iconSvg);
var _formProduct = require("./template/formProduct");
var _renderSpinner = require("./loading/renderSpinner");
var _validateForm = require("scripts/helpers/validateForm");
class ProductView {
    constructor(mainContentSelector){
        this.initView = ()=>{
            this.renderStatusSelectOptions("select-status", (0, _selectOption.ProductStatusOptions));
            this.renderCategorySelectOptions("select-category", (0, _selectOption.ProductTypeOptions));
            this.renderTableHeader((0, _labels.PRODUCT_LABELS));
            this.bindToggleFormProduct();
        };
        this.displaySpinner = ()=>(0, _renderSpinner.toggleSpinner)(true);
        this.removeSpinner = ()=>(0, _renderSpinner.toggleSpinner)(false);
        //Render select HTML options based on `options` array.
        this.renderStatusSelectOptions = (elementId, options)=>{
            const statusSelect = document.getElementById(elementId);
            let allOptions = "";
            options.forEach((option)=>{
                const optionLabel = (0, _labels.PRODUCT_STATUS_LABEL)[option.value];
                const optionElement = `<option value='${option.value}'>${optionLabel ? optionLabel : "All Status"}</option>`;
                allOptions += optionElement;
            });
            if (statusSelect) statusSelect.innerHTML = allOptions;
        };
        this.bindToggleFormProduct = (handleShowEditForm)=>{
        ...
        this.renderCategorySelectOptions = (elementId, options)=>{
            ...
            if (categorySelect) categorySelect.innerHTML = allOptions;
        };
        //Render a table header row based on `labelHtmls` array.
        this.renderTableHeader = (labelHtmls)=>{
        ...
        this.bindFilterProduct = (renderProducts)=>{
            ...
            mainContent.addEventListener("keyup", (event)=>{
                (async ()=>{
                    const target = event.target;
                    if (!target.classList.contains("input-search") || event.key !== "Enter") return;
            ...
            mainContent.addEventListener("change", (event)=>{
                (async ()=>{
                    ...
                    const categoryElement = document.getElementById("select-category");
        ...
        if (!mainContentElement) throw new Error("Main content element not found");
        this.mainContent = mainContentElement;
    }
    removeModal(elementName) {
        const modalOverlay = document.querySelector(`.modal-overlay-${elementName}`);
        modalOverlay?.remove();
    }
    displayProducts(products, isLoading) {
        const mainContent = document.getElementById("product-list");
        if (!mainContent) return; // this line should show error
        ...
        if (isLoading) {
            ...
            listItemHTML += '<p class="text-large text-center">No products at this moment.</p>';
            listItemHTML += "</ul>";
        } else {
            products.map((products)=>{
				...
				<li class="product-row product-item" data-field="name" data-sort-label="true" >
					...
					<p class="text-responsive label ${status}">${(0, _labels.PRODUCT_STATUS_LABEL)[status]}</p>
					<div class="btn-actions-group">
						<button class="btn-action btn-edit-product" data-product-id="${id}">
							<svg width="20" height="20" fill="blue" viewBox="0 0 24 24">
								<use
									xlink:href="${(0, _iconSvgDefault.default)}#pen-icon"
								></use>
							</svg>
						</button>
						<button class="btn-action btn-delete-product" data-product-id="${id}">
							<svg width="20 " height="20" fill="red" viewBox="0 0 41.336 41.336">
								<use
									xlink:href="${(0, _iconSvgDefault.default)}#trash-can"
								></use>
							</svg>
						</button>
					</div>
    ...
    displayProductForm(isEditForm, product) {
        const formProductWrapper = document.getElementById("form-product-wrapper");
        if (formProductWrapper === null) return;
        if (isEditForm) formProductWrapper.innerHTML += (0, _formProduct.formProductTemplate)(true, product);
        else formProductWrapper.innerHTML += (0, _formProduct.formProductTemplate)(false);
    }
    bindProductAction(handleAddProduct, handleEditProduct) {
        const formProductWrapperElement = document.getElementById("form-product-wrapper");
        formProductWrapperElement?.addEventListener("click", (event)=>{
            (async ()=>{
                ...
                const formFields = [
                    {
                        ...
                        validators: [
                            (0, _validateForm.isNotEmptyField),
                            (0, _validateForm.isAllowedString),
                            (0, _validateForm.hasMinLength)
                        ]
                    },
                    {
                        field: "sku",
                    ...
                    },
                    {
                        ...
                        validators: [
                            (0, _validateForm.isNotEmptyField),
                            (0, _validateForm.isInteger),
                            (0, _validateForm.isPositiveNumber)
                        ]
                    },
                    {
                        field: "price",
                        ...
                        validators: [
                            (0, _validateForm.isNotEmptyField),
                            (0, _validateForm.isNumber),
                            (0, _validateForm.isPositiveNumber),
                            ()=>(0, _validateForm.isGreaterOrEqual)(formData.get("price"), {
                    ...
                    },
                    {
                        ...
                        validators: [
                            ...
                            (0, _validateForm.isNumber),
                            (0, _validateForm.isPositiveNumber),
                            ()=>(0, _validateForm.isLesserOrEqual)(formData.get("cost"), {
                                    value: formData.get("price"),
                                    field: "Price"
                                })
                        ]
                ...
                const formError = (0, _validateForm.validateForm)(formFields);
                for(const key in formError){
                    (0, _validateForm.renderErrorMessages)(formElement, {});
                    if (formError[key] !== "") return (0, _validateForm.renderErrorMessages)(formElement, formError);
                }
                const product = {
                ...
                if (productId) await handleEditProduct(productId, product);
    ...
    bindRemoveModal() {
        document.addEventListener("mousedown", (event)=>{
            const target = event.target;
            if (target.classList.contains("modal-overlay")) target.remove();
        });
    }
        ...
        this.mainContent.addEventListener("click", (event)=>{
            (async ()=>{
                ...
                if (target.parentNode !== null) {
                    ...
                    targetSiblings.filter((sibling)=>sibling !== target).forEach((sibling)=>{
...
},{"../constants/selectOption":"2sAp1","@/constants/labels":"8V76C","../../asset/images/icon.svg":"1RksF","./template/formProduct":"gDVzC","./loading/renderSpinner":"eCOqG","scripts/helpers/validateForm":"4XLDC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2sAp1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ProductStatusOptions", ()=>ProductStatusOptions);
parcelHelpers.export(exports, "ProductTypeOptions", ()=>ProductTypeOptions);
var _labels = require("./labels");
const ProductStatusOptions = [
    {
        label: (0, _labels.PRODUCT_STATUS).ALL_STATUS,
        value: (0, _labels.PRODUCT_STATUS).ALL_STATUS,
        selected: true,
        classes: "product-status-option"
    },
    {
        label: (0, _labels.PRODUCT_STATUS).BEST_SELLER,
        value: (0, _labels.PRODUCT_STATUS).BEST_SELLER,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_STATUS).POOR_SELLER,
        value: (0, _labels.PRODUCT_STATUS).POOR_SELLER,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_STATUS).ON_SALE,
        value: (0, _labels.PRODUCT_STATUS).ON_SALE,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_STATUS).NEW_ARRIVAL,
        value: (0, _labels.PRODUCT_STATUS).NEW_ARRIVAL,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_STATUS).LOW_STOCK,
        value: (0, _labels.PRODUCT_STATUS).LOW_STOCK,
        selected: false
    }
];
const ProductTypeOptions = [
    {
        label: (0, _labels.PRODUCT_TYPE).ALL_CATEGORY,
        value: "",
        selected: true,
        classes: "product-status-option"
    },
    {
        label: (0, _labels.PRODUCT_TYPE).SKIN_CARE,
        value: (0, _labels.PRODUCT_TYPE).SKIN_CARE,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_TYPE).FACE_CARE,
        value: (0, _labels.PRODUCT_TYPE).FACE_CARE,
        selected: false
    },
    {
        label: (0, _labels.PRODUCT_TYPE).LIPS_CARE,
        value: (0, _labels.PRODUCT_TYPE).LIPS_CARE,
        selected: false
    }
];

},{"./labels":"8V76C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8V76C":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "PRODUCT_STATUS_LABEL", ()=>PRODUCT_STATUS_LABEL);
parcelHelpers.export(exports, "PRODUCT_TYPE", ()=>PRODUCT_TYPE);
parcelHelpers.export(exports, "PRODUCT_TYPE_OPTIONS", ()=>PRODUCT_TYPE_OPTIONS);
parcelHelpers.export(exports, "PRODUCT_STATUS", ()=>PRODUCT_STATUS);
parcelHelpers.export(exports, "PRODUCT_STATUS_OPTIONS", ()=>PRODUCT_STATUS_OPTIONS);
parcelHelpers.export(exports, "PRODUCT_LABELS", ()=>PRODUCT_LABELS);
...
(function(PRODUCT_TYPE) {
    PRODUCT_TYPE["ALL_CATEGORY"] = "All category";
    PRODUCT_TYPE["SKIN_CARE"] = "Skin care";
    PRODUCT_TYPE["FACE_CARE"] = "Face care";
    PRODUCT_TYPE["LIPS_CARE"] = "Lips care";
...
(function(PRODUCT_STATUS) {
    PRODUCT_STATUS["ALL_STATUS"] = "";
    PRODUCT_STATUS["BEST_SELLER"] = "bestSeller";
    PRODUCT_STATUS["POOR_SELLER"] = "poorSeller";
    PRODUCT_STATUS["ON_SALE"] = "onSale";
    PRODUCT_STATUS["NEW_ARRIVAL"] = "newArrival";
    PRODUCT_STATUS["LOW_STOCK"] = "lowStock";
...
},{}],"1RksF":[function(require,module,exports) {
module.exports = require("97ef4687c07e9c0b").getBundleURL("7XnOB") + "icon.2d1e5efd.svg" + "?" + Date.now();

},{"97ef4687c07e9c0b":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"gDVzC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "formProductTemplate", ()=>formProductTemplate);
var _labels = require("scripts/constants/labels");
const formProductTemplate = (isEditForm, data)=>{
    const { id = "", name = "", category = "", sku = "", quantity = "", price = "", cost = "", status = "" } = data ?? {};
    const typeOptionsHtml = Object.values((0, _labels.PRODUCT_TYPE)).map((item)=>`<option selected="${item === category}" >${item}</option>`).join("");
    let statusOptionsHtml = "";
    for(const statusLabel in 0, _labels.PRODUCT_STATUS_LABEL){
        const value = (0, _labels.PRODUCT_STATUS_LABEL)[statusLabel];
...
},{"scripts/constants/labels":"8V76C","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eCOqG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "toggleSpinner", ()=>toggleSpinner);
const toggleSpinner = (isHidden)=>{
    const spinnerModalElement = document.querySelector(".spinner-modal");
    if (isHidden) spinnerModalElement.classList.remove("hidden");
    else if (!isHidden && !spinnerModalElement.classList.contains("hidden")) spinnerModalElement.classList.add("hidden");
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4XLDC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isNotEmptyField", ()=>isNotEmptyField);
parcelHelpers.export(exports, "isAllowedString", ()=>isAllowedString);
parcelHelpers.export(exports, "isGreaterOrEqual", ()=>isGreaterOrEqual);
parcelHelpers.export(exports, "isLesserOrEqual", ()=>isLesserOrEqual);
parcelHelpers.export(exports, "hasMinLength", ()=>hasMinLength);
parcelHelpers.export(exports, "isValidSKU", ()=>isValidSKU);
parcelHelpers.export(exports, "isNumber", ()=>isNumber);
parcelHelpers.export(exports, "isInteger", ()=>isInteger);
parcelHelpers.export(exports, "isPositiveNumber", ()=>isPositiveNumber);
parcelHelpers.export(exports, "renderErrorMessages", ()=>renderErrorMessages);
...
const { getIsEmptyField, getUnallowedStringError, getInvalidSKUError, getNotNumberError, getNotIntegerError, getNotPositiveError, getNotEnoughCharacterError, getNotGreaterError, getNotLesserError } = (0, _message.ValidationErrors);
const { validSKURegex, allowedStringRegex } = (0, _regexDefault.default);
const isNotEmptyField = (value)=>value !== "" ? "" : getIsEmptyField();
const isAllowedString = (value)=>allowedStringRegex.test(value) ? "" : getUnallowedStringError();
const hasMinLength = (value)=>value.length >= 5 ? "" : getNotEnoughCharacterError(5);
const isGreaterOrEqual = (value, target)=>parseFloat(value) >= parseFloat(target.value) ? "" : getNotGreaterError(target.field);
const isLesserOrEqual = (value, target)=>parseFloat(value) <= parseFloat(target.value) ? "" : getNotLesserError(target.field);
const isValidSKU = (value)=>validSKURegex.test(value) ? "" : getInvalidSKUError();
const isNumber = (value)=>!isNaN(parseFloat(value)) && parseFloat(value).toString() === value ? "" : getNotNumberError();
const isInteger = (value)=>Number.isInteger(parseFloat(value)) ? "" : getNotIntegerError();
const isPositiveNumber = (value)=>parseFloat(value) >= 0 ? "" : getNotPositiveError();
const validateForm = (formFields)=>{
    const formError = {};
    formFields.forEach((formField)=>{
        const { field, value, validators } = formField;
        for (const validator of validators){
            if (formError[field] && formError[field] !== "") break;
...
const renderErrorMessages = (element = document, formError)=>{
    ...
    errorMsgElements.forEach((element)=>{
        ...
        if (field) element.textContent = formError[field] ?? "";
    });
};

},{"../constants/message":"8zBTk","../constants/regex":"gBzAC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8zBTk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NOTIFY_MESSAGES", ()=>NOTIFY_MESSAGES);
parcelHelpers.export(exports, "ValidationErrors", ()=>ValidationErrors);
...
const ValidationErrors = {
    ...
    getInvalidSKUError: ()=>'SKU\'s format: 2 letters, followed by a hyphen, and then 4 numbers like "wl-2444"',
    ...
    getNotGreaterError: (targetField)=>`This field must be greater than ${targetField}!`,
    getNotLesserError: (targetField)=>`This field must be lesser than ${targetField}!`,
    getNotEnoughCharacterError: (min)=>`This field should have at least ${min} characters`
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gBzAC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const REGEX = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8PaIS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ProductController {
   ...
   */ this.renderProducts = async (params = {}, products)=>{
   ...
   */ this.handleAddProduct = async (product)=>{
            try {
   ...
   */ this.handleShowEditForm = async (id)=>{
            this.productView.displaySpinner();
   ...
   */ this.handleEditProduct = async (id, product)=>{
            try {
                this.productView.displaySpinner();
                const products = await this.productModel.editProduct(id, product);
                this.productView.removeSpinner();
                (0, _toast.showSuccess)({
                    text: EDIT_SUCCESS_MSG
                });
                this.productView.removeModal("form");
                this.productView.displayProducts(products, false);
            } catch (error) {
                (0, _toast.showError)({
                    text: EDIT_FAILED_MSG
                });
            }
        };
        /**
   ...
   */ this.handleDeleteProduct = async (id)=>{
        ...
        this.handleSortProducts = async (params = {})=>{
            await this.renderProducts(params, []);
        };
...
},{"scripts/views/toast":"ef5j8","../constants/message":"8zBTk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ef5j8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const showSuccess = ({ text, duration = 2000 })=>notify({
        text,
        state: "success",
        duration
    });
const showError = ({ text, duration = 2000 })=>notify({
        text,
        state: "error",
        duration
    });
const notify = ({ text, state, duration })=>{
...
},{}],"943FW":[function() {},{}],"bb6qN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class ProductModel {
   ...
   */ async addProduct(product) {
        const data = await this.httpService.post(products, product);
   ...
   */ async editProduct(id, product) {
        const data = await this.httpService.put(`${products}/${id}`, product);
        if (data) this.products = this.products.map((item)=>item.id === id ? {
                ...item,
                ...data
            } : item);
        return this.products;
...
},{"../constants/endpoint":"cNUln","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cNUln":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"35WX5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class HttpService {
    constructor(){
        this.withApiErrorHandler = async (callBack)=>{
            try {
                const response = await callBack();
                return response.data;
            } catch (error) {
                const axError = error;
                if (!axError.response) throw new Error("Something went wrong. Please try again later.");
                throw axError.message;
            }
        };
        this.baseUrl = "https://65f15b5cda8c6584131d8be5.mockapi.io" ?? "";
        this.axiosClient = (0, _axiosDefault.default).create({
    ...
    async get(endpoint, params = {}) {
        return this.withApiErrorHandler(()=>this.axiosClient.get(`${endpoint}`, {
                params
            }));
    }
    async post(endpoint, data) {
        return this.withApiErrorHandler(()=>this.axiosClient.post(endpoint, data));
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5Sk58","j6eqU"], "j6eqU", "parcelRequire09fa")
